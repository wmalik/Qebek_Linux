################################################################################
#                                                                              #
#  Sebek-WIN32 v3.0.5:  kernel module for forensic data capture                #
#
...
Compiling Sebek:
	...
	3) Visual Studio later than if you want to use the preconfigured workspace/project files.
...
FAQ:
	...
	A: Report all bugs using the Honeynet Bug System at https://projects.honeynet.org/sebek (register an account
first) or you can contact the developer, Chengyu Song, at songchengyu@honeynet.org or join the honeypots mailing list(http://www.securityfocus.com/popups/forums/honeypots/intro.shtml) and ask for help there.
...
Bugs:
	...
	Report all bugs using the Honeynet Bug System at https://projects.honeynet.org/sebek
