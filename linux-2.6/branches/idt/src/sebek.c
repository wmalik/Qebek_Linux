...
//Kernel 2.6.26 drops struct's proc_dir_entry get_info_t *get_info member so in newer kernels we use read_proc_t as a function type 
#if ( LINUX_VERSION_CODE < KERNEL_VERSION(2,6,26) ) 
get_info_t * old_read_proc; 
#else 
read_proc_t * old_read_proc; 
#endif
