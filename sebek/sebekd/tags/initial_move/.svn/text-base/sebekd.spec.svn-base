...
install -m 0550 -o root -g root init.d/sebekd      $RPM_BUILD_ROOT/etc/init.d
install -m 0550 -o root -g root sebekd.pl      $RPM_BUILD_ROOT/%{sebeksbin}
install -m 0550 -o root -g root sbk_diag.pl        $RPM_BUILD_ROOT/%{sebeksbin}
install -m 0550 -o root -g root sbk_ks_log.pl      $RPM_BUILD_ROOT/%{sebeksbin}
install -m 0550 -o root -g root sbk_extract        $RPM_BUILD_ROOT/%{sebeksbin}
